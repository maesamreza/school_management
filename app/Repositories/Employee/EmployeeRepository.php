...
class EmployeeRepository {
	...
	public function create($params) {
		...
		$this->createEmployeeDesignation($employee, $employee_term->id, $params);
	 ...
	 * @param array $params
	 */
	public function createEmployeeDesignation(Employee $employee, $employee_term_id, $params = array()) {
